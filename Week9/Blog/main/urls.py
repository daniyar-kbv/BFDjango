...
from .views import PostListView, PostMoreView, PostCreateView, PostUpdateView, CreateCommentView, PostDeleteView, CommentDeleteView, CommentUpdateView

urlpatterns = [
    path('', PostListView.as_view(), name='blog'),
    path('<int:fk>/post', PostMoreView.as_view()),
